...
import static dev.rohitrawat.testnav.StickerContentProvider.ANDROID_APP_DOWNLOAD_LINK_IN_QUERY;
import static dev.rohitrawat.testnav.StickerContentProvider.ANIMATED_STICKER_PACK;
import static dev.rohitrawat.testnav.StickerContentProvider.AVOID_CACHE;
import static dev.rohitrawat.testnav.StickerContentProvider.IMAGE_DATA_VERSION;
import static dev.rohitrawat.testnav.StickerContentProvider.IOS_APP_DOWNLOAD_LINK_IN_QUERY;
import static dev.rohitrawat.testnav.StickerContentProvider.LICENSE_AGREEMENT_WEBSITE;
import static dev.rohitrawat.testnav.StickerContentProvider.PRIVACY_POLICY_WEBSITE;
import static dev.rohitrawat.testnav.StickerContentProvider.PUBLISHER_EMAIL;
import static dev.rohitrawat.testnav.StickerContentProvider.PUBLISHER_WEBSITE;
import static dev.rohitrawat.testnav.StickerContentProvider.STICKER_FILE_EMOJI_IN_QUERY;
import static dev.rohitrawat.testnav.StickerContentProvider.STICKER_FILE_NAME_IN_QUERY;
import static dev.rohitrawat.testnav.StickerContentProvider.STICKER_PACK_ICON_IN_QUERY;
import static dev.rohitrawat.testnav.StickerContentProvider.STICKER_PACK_IDENTIFIER_IN_QUERY;
import static dev.rohitrawat.testnav.StickerContentProvider.STICKER_PACK_NAME_IN_QUERY;
import static dev.rohitrawat.testnav.StickerContentProvider.STICKER_PACK_PUBLISHER_IN_QUERY;
